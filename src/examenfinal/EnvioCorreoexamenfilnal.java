...
public  class EnvioCorreoexamenfilnal {
    ...
    public EnvioCorreoexamenfilnal (String TO){
        this.TO = TO;}
    ...
    static final String SUBJECT = "Bienvendido al sistema para crear tareas";
    
    static final String BODY = "En este sistema podra llevar un orden de las diferentes tareas que debe completar en su día a día";
    ...
    public EnvioCorreoexamenfilnal() {
    }
